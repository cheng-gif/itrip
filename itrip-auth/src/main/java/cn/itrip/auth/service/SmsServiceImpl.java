...
public class SmsServiceImpl implements SmsService {
	...
	public static void main(String[] args) {
		...
		restAPI.setAccount("8a216da86f696570016f6e3d3ab70258", "3144d45ffe574007b083c417b6604ad1");

		restAPI.setAppId("8a216da86f696570016f6e3d3b23025f");
		...
		result = restAPI.sendTemplateSMS("18674918217","1" ,new String[]{code,"5"});
